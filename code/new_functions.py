...
def find_bottom(echodata, window_size, dead_zone, bottom_roughness_thresh, bottom_hardness_thresh):
    ...
    print(f'bottom roughness threshold: {bottom_hardness_thresh}, this file is {depth_roughness}')
    #print(f'bottom hardness threshold: {bottom_hardness_thresh}, this file is {hardness_mean}')
