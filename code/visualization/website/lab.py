...
if __name__ == "__main__":
    ...
    cmaps = plt.colormaps()
    raw_path = '/Volumes/T7 Shield/Data/Hudson Bay 2024'

    st.subheader("Select file")
    # year = st.selectbox("Which year will you work with?", (2018, 2019, 2020, 2021, 2022, 2023, 2024), index=6)
    fileslist = os.listdir(f'{raw_path}')
    fileslist = [file for file in fileslist[2:] if file.startswith('WBAT-Phase0-D2024')]
    ...
    data = process_data(path, envs, cals, 1, 'BB')
