...
file_list = sorted(glob.glob("../../../../../mnt/BSP_NAS2_work/Acoustics/Echopype_results/Baltic2024/run10okt24/img/*0_complete.png")) 
...
imcounter = 0 
length = 0
for i in range(0, length(final_list)):
    if length < 3000:
        tempfiles.append(file[i])
        counter += 1
        length += filelength[i]
    else:
